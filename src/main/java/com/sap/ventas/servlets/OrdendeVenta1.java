...
public class OrdendeVenta1 extends HttpServlet {
...
SAP(#         vendedor,idcliente,precio_total,precio_unitario,idproducto) select
SAP-#                 'v1','2018-11-02','rincon',4,'nada','saul',c.id,p.precio_venta*4,p.precio_venta,p.id
SAP-#         from producto p,cliente c where p.clave='PU1' AND c.id=3;
        */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OrdendeVenta1.class.getName()).log(Level.SEVERE, null, ex);
